        ...
        <table class="table">
            ...
            ?>
                    <tr>
                        ...
                        <td>
                            <a href="edit_barang.php?id_barang=<?php echo $result['id_barang'] ?>" class="btn btn-warning"><i class="fa-solid fa-pencil"></i> Edit</a>
                            <a href="hapus_barang.php?id_barang=<?php echo $result['id_barang'] ?>" onclick="return confirm('Kamu yakin ga?') " class="btn btn-danger"><i class="fa-solid fa-trash"></i> Hapus</a>
                        </td>
                    </tr>
            <?php
                }
