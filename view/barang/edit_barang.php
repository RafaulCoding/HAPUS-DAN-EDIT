    ...
    <div class="container">
        ...
        <form action="proses_edit_barang.php?id_barang=<?php echo $result['id_barang']; ?>" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" name="id_jenis" value="<?php echo $result['id_jenis']; ?>" id="exampleInputPassword1">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" name="stok" value="<?php echo $result['stok']; ?>" id="exampleInputPassword1">
            </div>
